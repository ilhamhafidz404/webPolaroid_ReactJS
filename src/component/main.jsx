        ...
        return (
            <main>
                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <div className="row product">
                            <div className="img col-lg-6" style={{ backgroundImage: `url("https://images.unsplash.com/photo-1601589689349-50bc966e89fc?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80")` }}>
                            </div>
                            <div className="text col-lg-6 d-flex align-items-center">
                            <div className="desk">
